...
export default function App() {
  ...
  // Load from local storage or fallback to pre-populated mock data on first execution
  useEffect(() => {
    // 1. User
    ...
    if (storedUser) {
      ...
      // Direct login to demo user automatically for smooth testing
        ...
        <>
          ...
          <aside className="hidden lg:flex flex-col w-64 bg-[#F1F2EB] text-[#2D332A] border-r border-[#D9DED1] shrink-0 select-none pb-4 relative z-20" id="sidebar_desktop">
            ...
            <nav className="flex-1 px-3 py-4 space-y-1" id="sidebar_nav_list">
              ...
              <SidebarItem id="assignments" icon={<FileText className="w-4 h-4" />} text="Assignment deadlocks" active={activeTab === 'assignments'} onClick={setActiveTab} />
              <SidebarItem id="exams" icon={<Calendar className="w-4 h-4" />} text="Exam countdowns" active={activeTab === 'exams'} onClick={setActiveTab} />
              ...
              <SidebarItem id="profile" icon={<User className="w-4 h-4" />} text="My Profile & Goals" active={activeTab === 'profile'} onClick={setActiveTab} />
              ...
              <>
                ...
                >
                  ...
                  <nav className="flex-1 px-3 py-4 space-y-1">
                    ...
                    <SidebarItem id="assignments" icon={<FileText className="w-4 h-4" />} text="Assignment deadlocks" active={activeTab === 'assignments'} onClick={(id) => { setActiveTab(id); setSidebarOpen(false); }} />
                    <SidebarItem id="exams" icon={<Calendar className="w-4 h-4" />} text="Exam countdowns" active={activeTab === 'exams'} onClick={(id) => { setActiveTab(id); setSidebarOpen(false); }} />
                    ...
                    <SidebarItem id="profile" icon={<User className="w-4 h-4" />} text="My Profile & Goals" active={activeTab === 'profile'} onClick={(id) => { setActiveTab(id); setSidebarOpen(false); }} />
