        ...
        if (decoded.password === password) {
          ...
          setTimeout(() => {
            onLoginSuccess({
              ...
              accentColor: decoded.accentColor || '#5A6F4D',
              language: decoded.language || 'English',
              timeFormat: decoded.timeFormat || '12',
              dateFormat: decoded.dateFormat || 'MM/DD/YYYY',
              notificationsEnabled: decoded.notificationsEnabled !== false,
